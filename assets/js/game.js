// Importing Audio and game control logic inspired by the MixorMatch Youtube Video by WebDevSimplified
...
// Game mechanics including countdown and flip card logic are adapted from MixorMatch by WebDevSimplified
class MuscleMemory {
	...
	cardMismatch(card1, card2) {
		...
		setTimeout(() => {
			card1.classList.remove("visible", "card-mismatch");
			card2.classList.remove("visible", "card-mismatch");
			this.busy = false;
		}, 1000);
	}

	// Shuffle function logic adapted from Fisher-Yates Algorithm
	shuffleCards() {
